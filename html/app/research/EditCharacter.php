...
if (isset($_POST['submit_Edit'])) {
		...
		if ($conn) {
			...
			$sql = "UPDATE EMM_ZOO.ANIMAL_CHARACTORISTICS
					SET RECORDID='$data[1]',EMPID='$data[2]',HEIGHT='$data[3]',WEIGHT='$data[4]',LENGTH='$data[5]',PATTERN='$data[6]',BodyTemperature='$data[7]'
						WHERE $data[0]=ANIMALID";
					echo $sql;
...
<html lang="en">
	...
	<?php 
	require_once ('/var/www/html/app/model/connect.php');
		$id=$_POST['EditCharacter'];
		$sql = "SELECT * FROM EMM_ZOO.animal_charactoristics WHERE RECORDID = $id;";
		echo $id;
