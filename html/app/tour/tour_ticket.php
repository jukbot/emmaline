                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr class="headings">
                                                <th>Tour Ticket ID </th>
                                                <th>Tour Ticket Date </th>
                                                <th>Tour Ticket Start Time </th>
                                                <th>Tour Ticket End Time </th>
                                        ...
                                        <tbody>
                                            <?php
                                            $conn = dbConnect();
                                            $sql = "SELECT TOURTICKETID, DATES, STARTTIME, ENDTIME, TYPE FROM EMM_ZOO.TOUR_TICKET";
                                            ...
                                            <tr>
                                                ...
                                                <td class=""><?php echo $sttime;?></td>
                                                <td class=""><?php echo $endtime;?></td>
