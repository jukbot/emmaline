                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr class="headings">
                                                <th>Tour Driver ID </th>
                                                <th>Tour Driver Name </th>
                                                <th>Tour Driver Email </th>
                                                <th>Tour Driver Phone </th>
                                                <th>Tour Driver Nationality </th>
                                        ...
                                        <tbody>
                                            <?php
                                            $conn = dbConnect();
                                            $sql = "SELECT DRIVERID, FIRSTNAME, LASTNAME, EMAIL, PHONE, NATIONALITY FROM EMM_ZOO.TOUR_DRIVER T, EMM_ZOO.EMPLOYEE E WHERE T.EMPID = E.EMPID";
