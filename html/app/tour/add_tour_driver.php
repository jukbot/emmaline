                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="controllerAddTourDriver.php" method="POST" class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" name="empId" required="required">
                                                    ...
                                                    require_once ('/var/www/html/app/model/connect.php');
                                                    $conn = dbConnect();
                                                    $sqlEmployee = "SELECT E.EMPID, E.FIRSTNAME, E.LASTNAME FROM EMM_ZOO.EMPLOYEE E,EMM_ZOO.TOUR_DRIVER D WHERE E.EMPID <> D.EMPID";
