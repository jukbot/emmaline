                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Promotion<small>Data</small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr class="headings">
                                                <th>Tour Promotion ID </th>
                                                <th>Tour Promotion Type </th>
                                                <th>Tour Promotion Price </th>
                                        ...
                                        <tbody>
                                            <?php
                                            $conn = dbConnect();
                                            $sql = "SELECT TOURPROMOID, TOURPROMOTYPE, PRICE FROM EMM_ZOO.TOUR_PROMOTION";
                                            $stmt = db2_prepare($conn, $sql);
                                            db2_execute($stmt);
                                            while ($row = db2_fetch_assoc($stmt)) {
                                                $id = $row['TOURPROMOID'];
                                                $type = $row['TOURPROMOTYPE'];
                                                $price = $row['PRICE'];
                                            ?>
                                            <tr>
