                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="controllerAddTourTicket.php" method="POST" class="form-horizontal form-label-left">
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Start Time
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="time" id="strtime" name="strtime" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="time" id="endtime" name="endtime" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <?php
                                                $conn = dbConnect();
                                                $sqlTypeTicket = "SELECT TOURTICK_TYPEID, TOURTICK_TYPE FROM EMM_ZOO.TOUR_TICKET_TYPE";
                                                $stmt = db2_prepare($conn, $sqlTypeTicket);
                                                $rs = db2_execute($stmt);
                                                while ($row = db2_fetch_assoc($stmt)) {
                                                    $typeId = $row['TOURTICK_TYPEID'];
