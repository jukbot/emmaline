                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="controllerAddTourVehicle.php" method="POST" class="form-horizontal form-label-left">

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="driver">Driver
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" name="driverId" required="required">
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $driverId; ?>"><?php echo $name; ?></option>
                                                    <?php
                                                    }
                                                    db2_free_stmt($stmt);
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="guide">Guide
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" name="guideId" required="required">
                                                    <option value="">Choose..</option>
                                                    <?php
                                                    $sqlGuide = "SELECT G.GUIDEID, E.FIRSTNAME, E.LASTNAME FROM EMM_ZOO.TOUR_GUIDE G, EMM_ZOO.EMPLOYEE E WHERE G.EMPID = E.EMPID";
                                                    $stmt = db2_prepare($conn, $sqlGuide);
                                                    $result = db2_execute($stmt);
                                                    while ($row = db2_fetch_assoc($stmt)) {
                                                        $guideId = $row['GUIDEID'];
                                                        $name = $row['FIRSTNAME']."  ".$row['LASTNAME'];
                                                    ?>
                                                    <option value="<?php echo $guideId; ?>"><?php echo $name; ?></option>
                                                    <?php
                                                    }
                                                    db2_free_stmt($stmt);
                                                    ?>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vehicle">Vehicle
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" name="carId" required="required">
                                                    <option value="">Choose..</option>
                                                    <?php
                                                    $sqlVehicle = "SELECT CARID,LICENSE_PLATE,CARTYPE FROM EMM_ZOO.CARS WHERE AVAILABLE = 'Y'";
                                                    $stmt = db2_prepare($conn, $sqlVehicle);
                                                    $result = db2_execute($stmt);
                                                    while ($row = db2_fetch_assoc($stmt)) {
                                                        $carId = $row['CARID'];
                                                        $carType = $row['CARTYPE'];
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $carId; ?>"><?php echo $license_plate."  ".$carType; ?></option>
                                                    <?php
                                                    }
                                                    db2_free_stmt($stmt);
                                                    db2_close($conn);
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="amount">Max Amount
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
