...
<body>
    ...
    <thead>
      <tr>
        ...
        <th><center>Uniform Type</center></th>
        <th><center>Amount</center></th>
        <th><center>Get Date</center></th>
...
<?php
    ...
    if ($conn) {
        $sql = "SELECT G.EMPID, FIRSTNAME, LASTNAME, UNIFORMTYPE, AMOUNT, GETDATE
                FROM EMM_ZOO.EMPLOYEE AS E, EMM_ZOO.UNIFORM AS U, EMM_ZOO.GETUNIFORM AS G
                WHERE E.EMPID = G.EMPID AND U.UNIFORMID = G.UNIFORMID
                ORDER BY G.EMPID, GETDATE";
  ...
  echo("</table>
                ...
                <div class='btn-group pull-right'   >
                    <button type='button' onclick='location.href='#';' class='btn btn-success'>ADD</button>
                </div> 
            </div>
        </div>
        ...
        <div class='row'>
            <div class='box'>
                <div class='col-lg-12'>
                    <hr>
                    <h2 class='intro-text text-center'>
                        <strong>RETURNING UNIFORM</strong>
                    </h2>
                    <hr>
                </div>
    ...
    <thead>
      <tr>
        ...
        $sql = "SELECT G.EMPID, FIRSTNAME, LASTNAME, UNIFORMTYPE, R.AMOUNT, RETURNDATE
                FROM EMM_ZOO.EMPLOYEE AS E, EMM_ZOO.UNIFORM AS U, EMM_ZOO.GETUNIFORM AS G, EMM_ZOO.RETURNUNIFORM AS R
                WHERE E.EMPID = G.EMPID AND U.UNIFORMID = G.UNIFORMID AND G.GETID = R.GETID
                ORDER BY G.EMPID, GETDATE";
