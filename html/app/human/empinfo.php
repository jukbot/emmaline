...
<?php
    if ($conn) {
        ...
        $sql = "SELECT EMPID, FIRSTNAME, LASTNAME, EMAIL, PHONE, JOBTYPE
                FROM EMM_ZOO.EMPLOYEE AS E JOIN EMM_ZOO.JOB AS J ON E.JOBID = J.JOBID 
            ...
            <tr>
                ...
                <td align=\"center\">
                    <form method='POST' action='empdetail.php'> 
                        <input type='hidden' value=". $row[0]." name='EMPID' id='EMPID'/>
...
?>
                ...
                <div class="btn-group pull-right"   >
                    <button type="button" onclick="location.href='addemp.php';" class="btn btn-success">ADD</button>
                </div> 
