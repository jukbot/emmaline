...
<body>
    ...
    <thead>
      <tr>
        <th><center>Insurance ID</center></th>
...
<?php
    ...
    if ($conn) {
        $sql = "SELECT I.INSID, I.EMPID, FIRSTNAME, LASTNAME, I.DATES, SUM(H.MONEY)
                ...
                WHERE E.EMPID = I.EMPID AND I.INSID = H.INSID
    ...
    echo("<tbody>
            <tr>
                ...
                <td align=\"center\">
                    <form method='POST' action='insurancedetail.php'> 
                        <input type='hidden' value=". $row[0]." name='INSID' id='INSID'/>
                        <input type='hidden' value=". $row[1]." name='EMPID' id='EMPID'/>
				        <button type='submit' name='more' class='btn btn-default btn-sm'>
