...
<?php
    ...
    if ($conn) {
        $sql = "SELECT E.EMPID, FIRSTNAME, LASTNAME, DATES, STARTTIME, ENDTIME, HOUR(ENDTIME - STARTTIME)
                FROM EMM_ZOO.EMPLOYEE AS E JOIN EMM_ZOO.OT AS OT ON E.EMPID = OT.EMPID
                ORDER BY DATES, E.EMPID";
