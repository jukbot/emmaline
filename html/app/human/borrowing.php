            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>BORROWING EMPLOYEES<br/>FROM CO-OPERATIVE ZOO</strong>
                    </h2>
                    <hr>
                </div>
...
<?php
    ...
    if ($conn) {
        $sql = "SELECT B.PARTTIMEID, FIRSTNAME, LASTNAME, JOBTYPE, STARTDATE, ENDDATE
                FROM EMM_ZOO.BORROWEMP AS B, EMM_ZOO.PARTTIME AS P, EMM_ZOO.JOB AS J
                WHERE B.PARTTIMEID = P.PARTTIMEID AND P.JOBID = J.JOBID
                ORDER BY STARTDATE desc, B.PARTTIMEID";
  ...
  echo("</table>
        ...
        <div class='row'>
            <div class='box'>
                <div class='col-lg-12'>
                    <hr>
                    <h2 class='intro-text text-center'>
                        <strong>OUR EMPLOYEES<br/>WHO ARE BORROWED</strong>
                    </h2>
                    <hr>
                </div>
    ...
    <thead>
      <tr>
        ...
        $sql = "SELECT B.EMPID, FIRSTNAME, LASTNAME, ZOONAME, STARTDATE, ENDDATE
                FROM EMM_ZOO.EMPBORROWED AS B, EMM_ZOO.EMPLOYEE AS E, EMM_ZOO.ZOO AS Z
                WHERE B.EMPID = E.EMPID AND B.ZOOID = Z.ZOOID
                ORDER BY STARTDATE desc, B.EMPID";
