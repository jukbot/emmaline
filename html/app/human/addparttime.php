            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>ADD NEW PARTTIME</strong>
                    </h2>
                    <hr>
                </div>
                        ...
                        <?php
                            echo("<div class='form-group col-lg-6'>
                                ...
                                <select name='zone'  class='form-control'>
                                    <option value='' disabled selected>Please choose co-operative zoo</option>");
                                    
                                        if ($conn) {

                                            $sql = "SELECT ZOONAME FROM EMM_ZOO.ZOO;";
                        ...
                        ?>
                            ...
                            <div class="form-group col-lg-12"><center>
                                ...
                                <button type="button" onclick="location.href='parttime.php';" class="btn btn-success">CANCEL</button></center>
                            </div>
