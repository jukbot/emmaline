...
<html>
    ...
    <body style="background-color:#FFFFCC">
        <div class="container">
            ...
            <br><center>
            <a href="car_infoGcarID.php" onclick="window.history.back();" style:="" "padding-right:="" 30px" style="padding-right: 30px;"><button type="button" class="btn btn-default" style="width : 260px">Order by Type</button></a>
            </center>
            <padding-left>
