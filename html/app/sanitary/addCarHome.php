...
if (isset($_POST['submit']) && (!empty($_POST['carid']))) {
insertSaniCar();
...
<html>
  <head>
    ...
    <title>ADD SANITATION CAR</title>
                      ...
                      <div class="col-md-6">
                        <form role="form" method="post" accept-charset="utf-8">
                          <div class="form-group">
                            ...
                            <input type="text" placeholder="90xx" class="form-control" name="carid" />
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" placeholder="XX000" class="form-control" name="carplate" />
                            </div>
