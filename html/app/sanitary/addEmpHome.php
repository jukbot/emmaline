...
<html>
  <head>
    ...
    <title>ADD SANITATION EMPLOYEE</title>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="empid" />
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" placeholder="F or M" class="form-control" name="sex" />
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" placeholder="City.." class="form-control" name="address" />
                              </div>
                              <div class="form-group">
                                ...
                                <input type="email" placeholder="xxx@xxx.com" class="form-control" name="email" />
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" placeholder="0XX-XXX-XXXX" class="form-control" name="phone" />
                              </div>
