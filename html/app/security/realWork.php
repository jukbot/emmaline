...
<div id="container">
    <img  HEIGHT="600" WIDTH="1450" src="img/bg11.jpg" alt="" />
</div>
...
<div class="modal-body">
   ...
   $sql = "SELECT * FROM EMM_ZOO.GUARD_REALWORK INNER JOIN EMM_ZOO.GUARD ON (EMM_ZOO.GUARD_REALWORK.GUARDID = EMM_ZOO.GUARD.GUARDID) ORDER BY DATES;";
if ($conn) {
	...
	if($stmt) {
		while ($row = db2_fetch_assoc($stmt)) {
            ...
            print "<form action='deleteRealwork.php' method='post'>";
                        
            print "<td><input type='hidden' name='deleteRealworkID' value='".$row['GUARDID']."'  >";
            print "<td><input type='hidden' name='dates' value='".$row['DATES']."'  >";
            
            print "<button type='submit' name='deleteRealworkSubmit' class='btn btn-default btn-danger'><span class='glyphicon glyphicon-remove'></span></button></td>";
	...
	echo db2_conn_errormsg($conn);
        ...
        <div align="right" >
        <a href="javascript:void(0)" onclick="toggle_visibility('popupBoxOnePosition');"><button  class='btn btn-default btn-lg' ><h3>Check In</h3><span class='glyphicon glyphicon-plus'> </span></button></a>
        
    <a href="javascript:void(0)" onclick="toggle_visibility('popupBoxTwoPosition');"><button  class='btn btn-default btn-lg' ><h3>Check Out</h3><span class='glyphicon glyphicon-plus'> </span></button></a>
    ...
    <div id="popupBoxOnePosition">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form name="sentMessage" action="addTimeIn.php" method="post" id="contactForm" >
                        <div class="row">
                            <div class="col-md-6">
     ...
     <div id="popupBoxTwoPosition">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form name="sentMessage" action="addTimeOut.php" method="post" id="contactForm" >
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    GUARD ID :
