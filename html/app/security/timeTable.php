...
<div id="container">
    <img  HEIGHT="600" WIDTH="1450" src="img/bg2.jpg" alt="" />
</div>
...
<div class="modal-body">
   ...
   $sql = "SELECT * FROM EMM_ZOO.GUARD_TIMETABLE INNER JOIN EMM_ZOO.GUARD ON (EMM_ZOO.GUARD_TIMETABLE.GUARDID = EMM_ZOO.GUARD.GUARDID) ORDER BY DATES;";
if ($conn) {
	...
	if($stmt) {
		while ($row = db2_fetch_assoc($stmt)) {
            ...
            //print "<td><button type='submit' name='edit' class='btn btn-default btn-info'><span class='glyphicon glyphicon-pencil'></span></button></td>";
            print "<form action='deleteTimetable.php' method='post'>";
            
            print "<td><input type='hidden' name='deleteTimetableID' value='".$row['GUARDID']."'  >";
            print "<td><input type='hidden' name='dates' value='".$row['DATES']."'  >";
            
            print "<button type='submit' name='deleteTimetableSubmit' class='btn btn-default btn-danger'><span class='glyphicon glyphicon-remove'></span></button></td>";
    ...
    <div id="popupBoxOnePosition">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form name="sentMessage" action="addTimetable.php" method="post" id="contactForm" >
                        <div class="row">
                            <div class="col-md-6">
    ...
    <br> <br> DATE :
    <input type="text"  placeholder="2015-12-01 *" name="dates" style='border:2px solid #FFA54F;'>
    <br> <br> TIME IN :
    <input type="text"  placeholder="00.08.00 *" name="timeIn" style='border:2px solid #FFA54F;'>
    <br> <br> TIME OUT :
    <input type="text"  placeholder="00.12.00 *" name="timeOut" style='border:2px solid #FFA54F;'>
